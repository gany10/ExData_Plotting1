...
Feb2007$Global_reactive_power <- as.numeric(as.character(Feb2007$Global_reactive_power))
...
par(mfrow=c(2,2))
plot(Feb2007$Time, Feb2007$Global_active_power, type="l",xlab="",ylab="Global Active Power")
plot(Feb2007$Time, Feb2007$Voltage,type="l",xlab="datetime",ylab="Voltage")
...
plot(Feb2007$Time, Feb2007$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power" )
dev.off()